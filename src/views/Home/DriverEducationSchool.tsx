      ...
      <div className="w-full grid gap-8 grid-cols-1 lg:grid-cols-[2fr,1.7fr]">
        ...
        <div className="w-full flex flex-col gap-8">
          ...
          <div className="w-full flex flex-col gap-2">
            ...
            <p className="text-[16px] font-inter text-center text-[#6c757d]">
              To explore reputable Driver Education school options and learn more about their programs, visit <a href="https://drivers-ed-depot.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-orange-main">Drivers Ed Depot</a>.
            </p>
          </div>
        </div>
        {/* ==> right portion */}
